                        ...
                        <div class="modal-content ">
                            <div class="modal-header mb_modal_header">
                                <div class="mb_modal_header_h5">
                                    <h5 class="modal-title mb_modal_title" id="exampleModalLabel">訂單標號 : ${data.planOrdID}</h5>
                                </div>
                            ...
                            <div class="modal-body mb_modal_body">
                                <div id="planForm">
                                    ...
                                    <div class="mb_plan_time_range_btn">
                                        <button tyep="button" class="btn btn-outline-success mb_plan_time_range mb_plan_time_range_09_btn" >09:00 ~ 17:00</button>
                                        <button tyep="button" class="btn btn-outline-success mb_plan_time_range mb_plan_time_range_19_btn">19:00 ~ 21:00</button>
                                        <button tyep="button" class="btn btn-outline-success mb_plan_time_range mb_plan_time_range_21_btn">21:00 ~ 22:30</button>
                                    </div>
                                    <p style="margin-bottom: 10px;">請選擇每週收取日</p>
                                    <div class="mb_plan_weekly_btn">
                                        <button tyep="button" class="btn btn-outline-success mb_mon_btn mb_plan_weekly_btn_on">星期一</button>
                                        <button tyep="button" class="btn btn-outline-success mb_tue_btn">星期二</button>
                                        <button tyep="button" class="btn btn-outline-success mb_thu_btn">星期四</button>
                                        <button tyep="button" class="btn btn-outline-success mb_fri_btn">星期五</button>
                                        <button tyep="button" class="btn btn-outline-success mb_sat_btn">星期六</button>
                                    </div>       
                                </div>
                                    ...
                                    <form id="comForm">
                                        <div class="mb-3 mb_modal_body_div" >
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control mb_comTel" id="recipient-name${index}" required="required" value="${item.comTel!=null?item.comTel:''}" >
                                            </div>
...
$(function () {
    ...
    $(document).on("click","span.star",function(){
        ...
        $(this).closest("div.star_block").find("span.star").each(function(i,e){
            // console.log(this.closest("#myForm").find(textarea));
    ...
    let maxActiveButtons = 2;
    let activeButtonCount = 0;
    $(document).on("click",".mb_plan_time_range",function(){
        

        if(activeButtonCount < maxActiveButtons){
            $(this).addClass("mb_plan_time_btn_on");
            $(this).attr("rangeID","on")
            console.log(this);
            activeButtonCount++;
            console.log(activeButtonCount);
            if($(this).attr("rangeID").val()==$(".mb_plan_time_btn_on").attr("rangeID").val()){
                $(this).removeClass("mb_plan_time_btn_on");
                activeButtonCount--;
            }
        }else{
            // $(".mb_plan_time_range").removeClass("mb_plan_time_btn_on");
            // $(this).addClass("mb_plan_time_btn_on");
            // activeButtonCount--;
            // console.log(activeButtonCount);
        }
