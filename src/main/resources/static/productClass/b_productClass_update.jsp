			...
			<FORM METHOD="post" ACTION="pc.do" name="form1">
				<table>
					<tr>
						...
						<td><%=productClass.getpClassID()%></td>
					</tr>
					<tr>
						<td>商品類別名稱:</td>
						<td><input type="TEXT" name="pClassName"
							value="<%=productClass.getpClassName()%>" size="45" /></td>
					</tr>
				...
				<div class="row justify-content-start">
					...
					<button type="submit" onclick="history.go(-1)" class="sl_btn_disable">回上一頁</button>
						<input type="hidden" name="action" value="update"> <input
							type="hidden" name="pClassID"
							value="<%=productClass.getpClassID()%>">
